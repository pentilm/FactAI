...
if __name__ == "__main__":
	try:
		...
		endpoint = input("Endpoint (195.201.197.25:{}): ".format(registry["factai_service"]["grpc"])) if not test_flag else ""
		if endpoint == "":
			endpoint = "195.201.197.25:{}".format(registry["factai_service"]["grpc"])
